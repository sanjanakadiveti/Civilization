...
public class TerrainTileFX extends StackPane {
    ...
    public TerrainTileFX(TerrainTile tile) {
        ...
        // highLight = new Rectangle(70, 70, Color.BLUE);
    ...
    public void updateTileView() {
        ...
        if (getTile().isEmpty()) {
            ...
            Image i = getTile().getOccupant().getImage();
            icon = new ImageView(i);
            this.getChildren().add(icon);
        }
        if ((this.equals(GameController.getLastClicked()))) {
            overlay.setFill(Color.rgb(10, 80, 90, 0.5));
            String path = "src/main/java/view/sounds/click2.mp3";
