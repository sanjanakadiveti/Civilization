...
public class AbstractMenu {
    ...
    private String pathDone = "src/main/java/view/sounds/hahaha.mp3";
    private Media songDone = new Media(new File(pathDone).toURI().toString());
    private MediaPlayer playerDone = new MediaPlayer(songDone);
    ...
    public AbstractMenu() {
        ...
        exploreButton.setOnMousePressed(e -> {
                ...
                String path1 = "src/main/java/view/sounds/owl.mp3";
    ...
    public boolean endTurn() {
        ...
        if (GameController.getCivilization().getNumSettlements() <= 0) {
            ...
            String path = "src/main/java/view/sounds/evil.mp3";
